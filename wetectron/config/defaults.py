...
# INPUT.MAX_SIZE_TRAIN, while for testing it will be INPUT.MAX_SIZE_TEST
...
_C.MODEL.FASTER_RCNN = True

# Use weakly-supervised methods
_C.MODEL.WSOD_ON = False
...
# During train/test, all proposals specified in the file are used (no limit is applied)
# -----------------------------------------------------------------------------
_C.PROPOSAL_FILES = CN()
# Proposal files must be in correspondence with the datasets listed in DATASETS.TRAIN
_C.PROPOSAL_FILES.TRAIN = ()
# Test using these proposal files (must correspond with DATASETS.TEST)
_C.PROPOSAL_FILES.TEST = ()
...
_C.MODEL.ROI_BOX_HEAD.POOLER_METHOD = "ROIAlign"
_C.MODEL.ROI_BOX_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_BOX_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_BOX_HEAD.POOLER_SCALES = (1.0 / 16,)
# _C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 81
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 13
...
_C.MODEL.ROI_WEAK_HEAD = CN()
_C.MODEL.ROI_WEAK_HEAD.PREDICTOR = "MISTPredictor"
_C.MODEL.ROI_WEAK_HEAD.LOSS = "RoIRegLoss"
_C.MODEL.ROI_WEAK_HEAD.OICR_P = 0.15
_C.MODEL.ROI_WEAK_HEAD.REGRESS_ON = False
_C.MODEL.ROI_WEAK_HEAD.REGRESS_HEUR = "AVG"
# for partial labels
_C.MODEL.ROI_WEAK_HEAD.PARTIAL_LABELS = "none" # none | point | scribble
_C.MODEL.ROI_WEAK_HEAD.ROI_LOSS_REFINE = False

_C.MODEL.ROI_WEAK_HEAD.USE_TEMPLATE = False
...
# ---------------------------------------------------------------------------- #
_C.SOLVER_CDB = CN()
_C.SOLVER_CDB.BASE_LR = 0.001
_C.SOLVER_CDB.BIAS_LR_FACTOR = 2

_C.SOLVER_CDB.MOMENTUM = 0.9
_C.SOLVER_CDB.WEIGHT_DECAY = 0.0005
_C.SOLVER_CDB.WEIGHT_DECAY_BIAS = 0

_C.SOLVER_CDB.GAMMA = 0.1
_C.SOLVER_CDB.STEPS = (30000,)

_C.SOLVER_CDB.WARMUP_FACTOR = 1.0 / 3
_C.SOLVER_CDB.WARMUP_ITERS = 500
_C.SOLVER_CDB.WARMUP_METHOD = "linear"
...
# Heuristic used to combine results
#   Valid options: ('ID', 'AVG', 'UNION')
_C.TEST.BBOX_AUG.HEUR = "UNION"
